...
@Serializable
data class WPLauncherCookie4399Com(
    @SerialName("aim_info")
    ...
    val appChannel: String = "4399com",
    @SerialName("login_channel")
    val loginChannel: String = "4399com",
    @SerialName("platform")
    val platform: String = "ad",
    @SerialName("sdk_version")
    val sdkVersion: String = "3.12.2",
    @SerialName("sdkuid")
    val uid: String,
    ...
    constructor(uid: ULong, state: String): this(uid = uid.toString(), session = state)
