 ...
 * @param mode 是否应用纤细效果
 */
suspend fun WPLauncherAccountAPI.setSkin(itemId: ULong, mode: SkinMode = SkinMode.DEFAULT) = postWithAuth(
    path = "/user-game-skin-multi",
    body = arrayOf(9, 8, 2, 10, 7)
        .joinToString(",") { """{"game_type":$it,"skin_type":31,"skin_id":"$itemId","skin_mode":${mode.ordinal},"client_type":"java","entity_id":null}""" }
